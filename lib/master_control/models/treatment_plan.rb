        ...
        def json_schema
          {
            ...
            properties: {
              ...
              referring_provider_id: { type: ['string', 'null'], pattern: JSON_SCHEMA_PATTERNS[:uuid] },
              treating_provider_id: { type: ['string', 'null'], pattern: JSON_SCHEMA_PATTERNS[:uuid] },
              customer_service_line_id: { type: ['string', 'null'], pattern: JSON_SCHEMA_PATTERNS[:uuid] },
              backup_service_line_id: { type: ['string', 'null'], pattern: JSON_SCHEMA_PATTERNS[:uuid] },
              proposed_duration: { type: ['integer', 'null'] },
              current_approved_duration: { type: ['integer', 'null'] },
              total_approved_duration: { type: ['integer', 'null'] },
              duration_qualifier_id: { type: ['string', 'null'], pattern: JSON_SCHEMA_PATTERNS[:uuid] },
              proposed_started_at: { type: ['string', 'null'], format: 'date' },
              actual_started_at: { type: ['string', 'null'], format: 'date' },
              estimated_end_at: { type: ['string', 'null'], format: 'date' },
