...
RSpec.describe MasterControl::Models::CustomerAppEventsStatesRole do
  NULLEABLE_ATTRIBUTES = [].freeze

  let(:canonical_klass) { 'MasterControl::Models::CustomerAppEventsStatesRole' }
  ...
  let(:customer_app_events_state_id) { SecureRandom.uuid }
  ...
  let(:customer_app_events_states_role) do
    {
      ...
      role_id: role_id,
      customer_app_events_state_id: customer_app_events_state_id,
  ...
  def validate!
    JSON::Validator.validate!(MasterControl::Models::CustomerAppEventsStatesRole.json_schema, customer_app_events_states_role)
  end
