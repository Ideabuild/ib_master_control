...
RSpec.describe MasterControl::Models::CustomerAppNotification do
  NULLEABLE_ATTRIBUTES = [].freeze

  let(:canonical_klass) { 'MasterControl::Models::CustomerAppNotification' }
  ...
  let(:customer_app_notification) do
    {
  ...
  def validate!
    JSON::Validator.validate!(MasterControl::Models::CustomerAppNotification.json_schema, customer_app_notification)
  end
