...
RSpec.describe MasterControl::Models::DisclaimerType do
  NULLEABLE_ATTRIBUTES = [].freeze

  let(:canonical_klass) { 'MasterControl::Models::DisclaimerType' }
  ...
  let(:disclaimer_category_name) { 'Patient' }
  let(:disclaimer_category_system_code) { 'patient' }
  ...
  def validate!
    JSON::Validator.validate!(MasterControl::Models::DisclaimerType.json_schema, disclaimer_type)
  end
