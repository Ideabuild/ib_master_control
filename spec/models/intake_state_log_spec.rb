...
RSpec.describe MasterControl::Models::IntakeStateLog do
  NULLEABLE_ATTRIBUTES = [
    :state_out_at,
    :time_in_state
  ].freeze

  let(:canonical_klass) { 'MasterControl::Models::IntakeStateLog' }
  ...
  def validate!
    JSON::Validator.validate!(MasterControl::Models::IntakeStateLog.json_schema, intake_state_log)
  end
