...
RSpec.describe MasterControl::Models::InteractionOutcome do
  NULLEABLE_ATTRIBUTES = [].freeze

  let(:canonical_klass) { 'MasterControl::Models::InteractionOutcome' }
  ...
  def validate!
    JSON::Validator.validate!(MasterControl::Models::InteractionOutcome.json_schema, interaction_outcome)
  end
