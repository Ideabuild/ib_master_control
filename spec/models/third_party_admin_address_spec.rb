...
RSpec.describe MasterControl::Models::ThirdPartyAdminAddress do
  ...
  let(:canonical_klass) { 'MasterControl::Models::ThirdPartyAdminAddress' }
  let(:version) { 1 }
  ...
  let(:third_party_admin_address) do
    {
  ...
  def validate!
    JSON::Validator.validate!(MasterControl::Models::ThirdPartyAdminAddress.json_schema, third_party_admin_address)
  end
